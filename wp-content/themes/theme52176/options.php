...
// ---------------------------------------------------------
			...
			$options['google_mixed_3'] = array(
								'id' => 'google_mixed_3',
								'std' => array( 'size' => '14px', 'lineheight' => '24px', 'face' => 'Roboto, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#85837f'));

			$options['h1_heading'] = array(
								'id' => 'h1_heading',
								'std' => array( 'size' => '30px', 'lineheight' => '35px', 'face' => 'Roboto, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#4f4a47'));

			$options['h2_heading'] = array(
								'id' => 'h2_heading',
								'std' => array( 'size' => '48px', 'lineheight' => '57px', 'face' => 'Roboto, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#4f4a47'));

			$options['h3_heading'] = array(
								'id' => 'h3_heading',
								'std' => array( 'size' => '24px', 'lineheight' => '24px', 'face' => 'Roboto, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#292828'));

			$options['h4_heading'] = array(
								'id' => 'h4_heading',
								'std' => array( 'size' => '14px', 'lineheight' => '20px', 'face' => 'Roboto, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#4f4a47'));

			$options['h5_heading'] = array(
								'id' => 'h5_heading',
								'std' => array( 'size' => '12px', 'lineheight' => '18px', 'face' => 'Roboto, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#4f4a47'));
...
// ---------------------------------------------------------
			...
			$options['logo_typography'] = array(
								'id' => 'logo_typography',
								'std' => array( 'size' => '34px', 'lineheight' => '40px', 'face' => 'Cutive', 'style' => 'normal', 'character'  => 'latin', 'color' => '#4e4a47'));
...
// ---------------------------------------------------------
			...
			$options['menu_typography'] = array(
								'id' => 'menu_typography',
								'std' => array( 'size' => '24px', 'lineheight' => '24px', 'face' => 'Roboto, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#aba9a4'));
...
// ---------------------------------------------------------
			...
			$options['footer_menu_typography'] = array(
								...
								'std' => array( 'size' => '14px', 'lineheight' => '24px', 'face' => 'Roboto, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#d8d7d2'));
